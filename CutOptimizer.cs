    ...
    public static class CutOptimizer
    {
        public static List<CutBar> Optimize(List<double> parts, List<double> stocks, double reduction, double cutWidth)
        {
            ...
            while (remainingParts.Any())
            {
                ...
                // Добивка остальными деталями (First Fit)
